...
window.playSong = function playSong (buttonEl, src) {
  ...
  if (currentAudio && currentSongEl) {
    currentAudio.pause()
    currentSongEl.querySelector('.play-song-btn img').src = '/images/play-icon1623596730369.svg'
  }
  ...
  audio.addEventListener('canplay', function () {
    ...
    currentSongEl.querySelector('.play-song-btn img').src = '/images/pause-icon1623596730369.svg'
